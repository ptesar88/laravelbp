...
function FenceRoot(props: FenceRootProps) {
    ...
    const doplnekVybranOtiskBarva = chciBarvu == true && vybranaBarva !== null && chciOtisk == true && vybranyOtisk !== null || chciBarvu == false && chciOtisk == false || chciOtisk == true && vybranyOtisk !== null && chciBarvu == false || chciOtisk == false && chciBarvu == true && vybranaBarva !== null ? 'block' : 'hidden';
    const doplnekVybranBarva = chciBarvu == true && vybranaBarva !== null || chciBarvu == false ? 'block' : 'hidden';
    ...
    console.log("otisk", produkt.label, "chci barvu:", chciBarvu, doplnekVybran);
