    ...
    <div className="relative max-w-6xl">
        ...
        <div className="relative bg-white">
            ...
            <div className="mx-auto items-center grid mb-2 mt-2 max-w-6xl md:mb-8 md:grid-cols-1 md:gap-1">
                        <div>
                            <div className="flex">
                                ...
                                <div className="flex h-16 items-center ps-4 pe-4 mr-2 mb-2 border border-gray-200 bg-slate-200 rounded">
                                    <input id="inline-radio-doprava" type="radio" value="Ano" onChange={() => setChciDopravu(true)} name="doprava" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2" />
                                ...
                                <div className="flex h-16 items-center ps-4 pe-4 mb-2 border border-gray-200 bg-slate-200 rounded">
                                    <input id="inline-2-radio-doprava" type="radio" value="Ne" onChange={() => setChciDopravu(false)} name="doprava" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2" />
                        ...
                        <div>
                            <div className="flex">
                                <div className="flex items-center w-full me-4 ms-2 font-bold">
                                   Montáž - dohodou
                                </div>
                ...
                <span className="text-xs text-gray-500">*Poznámka: V případě, že si nevyberete dopravu, budete zajišťovat svépomocí.</span>
