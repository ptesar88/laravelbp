...
saveDemand = async (e: any) => {
    e.preventDefault();
    const { company, firstname, lastname, phone, email, checkbox } = this.state;
    if (company === '' || firstname === '' || lastname === '' || phone === '' || email === '' || checkbox === false) {
...
<form className="max-w-6xl mx-auto" onSubmit={this.saveDemand}>
